...
The 1.0 SDK requires Java 8 or later to be installed.
...
At time of writing (April 2026): 26 (Tahoe), 15 (Sequoia), and 14 (Sonoma).
****
...
| xref:python-analytics-sdk:hello-world:overview.adoc[Python Analytcis SDK Docs] 
| 1.0
