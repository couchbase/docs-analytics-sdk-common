= Compatibility
:description: Platform compatibility, and features available in different SDK versions, and compatibility between Enterprise Analytics and SDK. \
...
The 1.1 SDK requires Java 8 or later to be installed.
...
The {name-sdk} has been tested on a representative subset of the platforms listed below.
...
// tag::os-compat[]
Analytics SDKs can be expected to run on all of the Operating Systems supported by xref:{version-server}@server:install:install-platforms.adoc[Couchbase Server].
...
// tag::api-version[]
.Analytics SDK API Versions
[cols="20,20,20"]
|===
|  |  API 1.0  |  API 1.1

a| xref:dotnet-analytics-sdk:hello-world:overview.adoc[.NET Analytics SDK Docs] 
| 1.0
| 1.1

a| xref:go-analytics-sdk:hello-world:overview.adoc[Go Analytics SDK Docs] 
| 1.0
| 1.1

a| xref:java-analytics-sdk:hello-world:overview.adoc[Java Analytics SDK Docs] 
| 1.0
| 1.1

a| xref:nodejs-analytics-sdk:hello-world:overview.adoc[Node.js Analytics SDK Docs] 
| 1.0
| 1.1

a| xref:python-analytics-sdk:hello-world:overview.adoc[Python Analytcis SDK Docs] 
| 1.0
| 1.1
|===
// end::api-version[]
