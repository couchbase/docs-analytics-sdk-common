...
This branch contains common documents and document fragments for the 1.1 API release of each Analytics SDK.
It follows the https://docs.couchbase.com/analytics-java-sdk/1.0/project-docs/compatibility.html#api-version[Analytics SDK 1.1 API].
...
These partials are the common pages shared by all the Analytics SDKs.
